...
<div class="content_success " >
    <div class="con-ct   fo-con">
      ...
      <ul class="ct-list">
        ...
        <li >订单号：
            <em>
                    <?php if($master_order_sn != ''): ?>&nbsp;&nbsp;<?php echo ($master_order_sn); ?>
                    <?php else: ?>
        ...
        <li>支付金额：
            <em>
                    <?php if($master_order_sn != ''): ?>￥<?php echo ($sum_order_amount); ?>元                        
                    <?php else: ?>
                    	￥<?php echo ($order['order_amount']); ?>元<?php endif; ?>                        
            </em>
        </li>
      </ul>
    </div>
            ...
            <div class="content ptop0">
              <div class="panel panel-default info-box">
                <div class="panel-body" id="pay_div"  >
                  <div class="title" id="zhifutitle" style="border-bottom:1px solid #eeeeee;"> <span class="i-icon-arrow-down i-icon-arrow-up" id="zhifuip"></span> <span class="text">支付方式</span> <a href="javascript:void(0)" title="修改商品列表" class="link">钱包余额</a> <em class="qxz" id="emzhifu"><?php echo ($user['user_money']); ?></em> </div>
